...
<html lang="en">
    ...
    <body class="fixed-topbar fixed-sidebar theme-sdtl color-default dashboard">    
        <section>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="header">
                        <h2><strong>Mantenimiento de Menus</strong></h2>
                                ...
                                <div class="row">
                                    <div class="panel-content">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="tablaMenu"></table>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modalMenu" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" style="display: none;">
